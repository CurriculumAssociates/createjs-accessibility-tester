...
export default class ContentEditable extends createjs.Container {
  constructor(width, height, tabIndex) {
    ...
    // contentEditable.accessible.tabIndex = this._nextTab++;
    ...
    this.accessible.value = this._text;
  ...
  _onValueChanged(evt) {
    ...
    this.accessible.value = evt.newValue;
  }
